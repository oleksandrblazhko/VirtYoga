...
## Огляд
Це створена на основі комп'ютерного зору програма тренера з йоги, яка використовує веб-камеру для супроводу користувачів через пози йоги. Програма використовує рішення Google MediaPipe Pose для виявлення орієнтирів людського тіла та надання реального зворотного зв'язку про точність пози.
...
- Візуальний оверлей скелета, що показує орієнтири тіла
...
1. **Виявлення пози MediaPipe**
   ...
   - Виявляє 33 орієнтири тіла в режимі реального часу
   - Надає координати для кожного орієнтиру
